...
host = os.environ.get("TVM_TRACKER_HOST", "10.201.135.166")
port = int(os.environ.get("TVM_TRACKER_PORT", "8104"))
...
if env.TARGET == "pynq":
    ...
    remote = autotvm.measure.request_remote(
        env.TARGET, host, port, timeout=10000
    )
...
env = vta.get_env()
logging.basicConfig()
log_file = "vta_conv3d.log"
tmp_log_file = "vta_conv3d.log.tmp"
...
tuner.tune(
    ...
    callbacks=[
        autotvm.callback.progress_bar(tsk_trial, prefix="[Conv]: "),
